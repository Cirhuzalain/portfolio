...
export default function Quotes(){
    return (
        <div>
            ...
            <p>
                "The internet is a great equalizer, the fact that Google Search works the same whether you are a kid in rural India/elsewhere or a professor at Harvard/Stanford..."SP
            </p>
            <p>
