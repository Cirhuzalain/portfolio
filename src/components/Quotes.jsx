            ...
            <Header navInfo={navData} />
                <div className="section-content">
                    <div className="quotes-content card">
                        ...
                        <p>
                            "Most political debate ... is about our balance sheet ... but .... in order to solve the balance sheet,  you've got to grow the private sector."GB
                        </p>
                        <p>
                            "The survival of liberty in our land increasingly depends on the success of liberty in other lands."GB
                        </p>
                    </div>
                </div>
